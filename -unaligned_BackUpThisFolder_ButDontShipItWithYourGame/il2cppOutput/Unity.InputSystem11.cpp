...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void OneModifierComposite_DetermineValueTypeAndSize_mA17788396BBF726944E2E29CD678EF42CCF11EFA (InputBindingCompositeContext_t961CAA1DF29D7D4E0AE0AEF22400B285E17B1390* ___context0, int32_t ___part1, Type_t** ___valueType2, int32_t* ___valueSizeInBytes3, const RuntimeMethod* method) 
{
	...
	Type_t* V_3 = NULL;
	{
		...
		*((int32_t*)L_0) = (int32_t)0;
		...
		NullCheck(L_2);
		RuntimeObject* L_3;
		L_3 = InterfaceFuncInvoker0< RuntimeObject* >::Invoke(0, IEnumerable_1_t45141F64D6D882336B8DCC6510DC6B9C3294C6AA_il2cpp_TypeInfo_var, L_2);
		V_1 = L_3;
	}
	{
		auto __finallyBlock = il2cpp::utils::Finally([&]
...
IL_0013_1:
			{
				...
				L_7 = InterfaceFuncInvoker0< PartBinding_tB263B939F5CC92F02FD1C8892A194F9BC8A53D38 >::Invoke(0, IEnumerator_1_t5AFCED6452B2551E59D8997046D5F19C8F731FB3_il2cpp_TypeInfo_var, L_6);
				V_2 = L_7;
				int32_t L_8;
...
IL_0047_1:
			{
				...
				NullCheck(L_18);
				bool L_20;
				L_20 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(21, L_18, L_19);
				if (L_20)
				{
					goto IL_005b_1;
				}
